...
- NOI (monthly): $3,052
- Cash flow after debt: $-6,274
- DSCR: 0.33x (32.7%)

## What Must Be True (Targets)
- Cash gap (monthly): $-6,274 (negative means shortfall)
- Required utilization multiplier (cash break-even): 1.07x
- Required additional sales (per day): $364
- Notes: n/a

## Sensitivity (Cash After Debt)
| Lever | Cash after debt (monthly) |
| --- | --- |
| Utilization +10% | $2,115 |
| Utilization -10% | $-14,662 |
| Spend +10% | $-1,676 |
| Spend -10% | $-10,871 |
| Fixed costs +10% | $-14,357 |
| Fixed costs -10% | $1,810 |

## ROI Metrics
- Startup cost (likely): $620,000
- Payback period: 11.08 years

## Break-even Snapshots
- Monthly fixed costs: $80,835
- Gross margin (after variable costs): 57.4%
- Break-even sales (monthly): $140,752
- Break-even sales (per day, operating): $4,692
- Break-even sales (per day, after debt): $5,233
